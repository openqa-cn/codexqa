...
| --- | --- | --- |
| 🧭 | <a href="skills/codexqa-skill-router/README.zh-CN.md">codexqa-skill-router</a> | **什么时候用** 不确定该走缺陷扫描、影响面、用例还是造数；或者干活 skill 还没装。<br>**验证结果** 按你的话匹配到对应 skill，没有就按需装上再交接。你不用自己记八套入口，验证工作从「选对工具」开始。 |

...
- A skill directory uses a short action-oriented name, such as `code-analyzer`, `root-cause-diagnosis`, `defect-detection`, `code-reviewer`, `requirements-analyzer`, `testcase-generation`, or `testdata-generation`.

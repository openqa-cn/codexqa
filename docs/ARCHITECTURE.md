...
| --- | --- | --- |
| **Evaluating or using a skill** | The skill's own human-facing documentation (`README.md`, plus `HOW_IT_WORKS.md` / `KNOWN_LIMITATIONS.md` where present); [Getting Started](GETTING_STARTED.md), [Support matrix](SUPPORT_MATRIX.md), [FAQ](FAQ.md), [examples](../examples/README.md) | Start here. Enough to decide whether to trust the tool and how far. [Index of per-skill method docs](HOW_IT_WORKS.md). Sample HTML/screenshots: [README · Overview of all skills](../README.md#overview-of-all-skills). |

...
- H1 stays `codexqa`.
- The line under H1 is the post-AI-coding verification bottleneck (write fast vs know it is good), then the 360° test-and-verify dimensions, then quantified proof before the screenshot.

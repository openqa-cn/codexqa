...
import { ensure, gitnexusHooks, run_cli } from "../scripts/gitnexus.ts";
...
describe("gitnexus ensure", () => {
  ...
  beforeEach(() => {
    ...
    saved.DETECTION_SKIP_GITNEXUS = process.env.DETECTION_SKIP_GITNEXUS;
    process.env.CONTENT_JSON_BASE = tmp;
    process.env.DETECTION_DATA_DIR = tmp;
    // ensure() short-circuits when SKIP is set; these cases exercise the install path.
    delete process.env.DETECTION_SKIP_GITNEXUS;

...
This skill produces **graph-backed review reports**. It does not replace `codexqa-defect-analyzer` scan reports, `codexqa-code-analyzer` ad-hoc graph Q&A, or `codexqa-rootcause-analyzer` exception RCA.

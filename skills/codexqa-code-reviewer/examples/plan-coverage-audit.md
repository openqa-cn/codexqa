...
- audited_at: 2026-09-26T05:02:39Z
...
| A1 | 源码位于 skills/codexqa-code-reviewer/ (name=codexqa-code-reviewer) | I | **PASS** | path exists |
| A0 | SKILL.md name: codexqa-code-reviewer | I | **PASS** | frontmatter name |
...
| H8 | SKILL.md < 500 行 | I | **PASS** | lines=385 |

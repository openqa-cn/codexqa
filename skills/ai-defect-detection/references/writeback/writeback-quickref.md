...
> The authoritative, complete definition of field constraints and content format is `SKILL-WRITEBACK.md`. When wording disagrees, follow the main doc; the final authority is programmatic validation in `open_validate.ts`.
...
- Code-block language tag matches the project's actual language

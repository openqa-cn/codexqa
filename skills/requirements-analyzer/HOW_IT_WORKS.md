...
Agents read [`SKILL.md`](SKILL.md) then [`prompts/requirements-analyzer.md`](prompts/requirements-analyzer.md), not this page. Gaps: [Known limitations](KNOWN_LIMITATIONS.md).

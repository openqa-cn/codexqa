...
- [`code-wiki`](code-wiki/): local architecture knowledge graph — index a repo, export community digests with `wiki inputs` (no model), and write a DeepWiki-style HTML wiki (sidebar + article + TOC). [Skill README](code-wiki/README.md).

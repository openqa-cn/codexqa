...
description: >
  ...
  codexqa CLI (index, query). Not CodexQA evidence-pack HTML review (that is ai-code-reviewer), not SAST + Agent LLM Detection code-risk scan reports (that is defect-detection),

...
| 变更分析 / 变更代码分析 / 变更影响报告 / 影响入口 / 召回测试用例 / change impact report / change analysis, or impact words plus 报告 / 补测试 for one diff | `codexqa-change-analysis` | general symbol-graph Q&A (`codexqa-code-analyzer`), PRD case library |

...
Agent 运行时读 [`SKILL.md`](SKILL.md)，不要读本页。命令、安装、排障在英文 [HOW_IT_WORKS.md 操作附录](HOW_IT_WORKS.md#operator-appendix)。能力边界见[已知边界](KNOWN_LIMITATIONS.zh-CN.md)。回写样例：[预览页](https://cdn.jsdelivr.net/gh/openqa-cn/codexqa@main/docs/assets/previews/testdata-writeback.html)。

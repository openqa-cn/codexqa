#!/usr/bin/env python3
"""Freeze only Section 3 from the three explicit codexqa-testcase-generator templates."""
...
EXPECTED_SOURCE_SKILL_NAME = "codexqa-testcase-generator"
PLATFORM_FILES = {
...
def extract(args: argparse.Namespace) -> Dict:
    ...
    if source_skill_name != EXPECTED_SOURCE_SKILL_NAME:
        raise SkillError(
            ...
            "sourceSkillName must be the canonical codexqa-testcase-generator name",
            {

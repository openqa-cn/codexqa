...
<div class="wrap">
  <header class="hero">
    <p class="kicker">codexqa-testcase-generator · V56 · case report v{SCRIPT_VERSION}</p>
  ...
  <p class="footer">{_bi('由 codexqa-testcase-generator/scripts/generate_case_report.py 生成 · 仅本地 HTML，不上传用例平台', 'Generated by codexqa-testcase-generator/scripts/generate_case_report.py · local HTML only, no case-platform upload')}</p>
</div>
<script>
(function(){{

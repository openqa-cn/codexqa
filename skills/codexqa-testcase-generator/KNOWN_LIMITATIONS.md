...
This skill produces **test plans and manual cases**. It does not replace `codexqa-requirement-analyzer` for gap registers, `codexqa-testdata-generator` for live backend data, or code-review / scan skills for defect findings.

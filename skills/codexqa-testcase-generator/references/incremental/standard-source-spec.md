...
The script accepts only a directory the Agent passes explicitly, and does not look up Skill identity. `source-skill-name` must be `codexqa-testcase-generator`.

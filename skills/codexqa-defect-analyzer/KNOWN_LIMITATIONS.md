...
This skill produces **code-risk scan reports**. It does not replace `codexqa-code-reviewer` for CodexQA evidence-pack HTML review, `codexqa-code-analyzer` for change-impact mapping, or `codexqa-rootcause-analyzer` for exception RCA.

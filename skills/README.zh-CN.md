...
- [`defect-detection`](defect-detection/README.zh-CN.md)：面向 git 分支、PR 和测试计划的本地优先缺陷审查（Java / Kotlin 做到方法级；产出 HTML 报告，结论需人工确认）。[工作原理](defect-detection/HOW_IT_WORKS.zh-CN.md)。

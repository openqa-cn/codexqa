...
- [`code-wiki`](code-wiki/README.zh-CN.md)：本机架构知识图谱——先建索引，再用 `wiki inputs`（不调模型）导出社区 digest，写出 DeepWiki 风格的 HTML Wiki（侧栏 + 正文 + 本页目录）。[Skill 手册](code-wiki/README.zh-CN.md)。

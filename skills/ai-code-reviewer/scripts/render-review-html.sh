#!/usr/bin/env bash
# ai-code-reviewer: Render REVIEW-REPORT.html from review-conclusion.json.
...
jq \
  ...
  | $c0 + {
      ...
      skill: pick($c0.skill; $m0.skill // "ai-code-reviewer"),
...
jq -n -r --slurpfile p "$FRAG" --arg css "$CSS" '
  ...
  + "</div>\n"
  + "<div class=\"wrap\">\n"
  + "<header class=\"hero\"><div class=\"hero-inner\">\n<p class=\"eyebrow\" data-zh=\"审查档案 · ai-code-reviewer · CodexQA\" data-en=\"INSPECTION DOSSIER · ai-code-reviewer · CodexQA\">审查档案 · ai-code-reviewer · CodexQA</p>\n"
  ...
  + "<footer><span data-zh=\"由技能 ai-code-reviewer · CodexQA CLI · scripts/render-review-html.sh 生成\" data-en=\"Generated by skill ai-code-reviewer · CodexQA CLI · scripts/render-review-html.sh\">由技能 ai-code-reviewer · CodexQA CLI · scripts/render-review-html.sh 生成</span>"

...
Agent 运行时读 [`SKILL.md`](SKILL.md) 再读 [`prompts/codexqa-requirement-analyzer.md`](prompts/codexqa-requirement-analyzer.md)，不要读本页。能力边界见[已知边界](KNOWN_LIMITATIONS.zh-CN.md)。登记表样例：[预览页](https://cdn.jsdelivr.net/gh/openqa-cn/codexqa@main/docs/assets/previews/ra-register.html)。

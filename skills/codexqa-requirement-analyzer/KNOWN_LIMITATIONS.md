...
## This is not codexqa-testcase-generator

| | `codexqa-requirement-analyzer` | `codexqa-testcase-generator` |
|---|---|---|
...
`scripts/run_analysis.ts` and the parse/convert helpers move text between Markdown / JSON / CSV / Word-ish shapes. They do not score risks or fill the register. Analysis is the host agent following `prompts/codexqa-requirement-analyzer.md`.

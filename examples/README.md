...
The example is a ground-truth fixture and does not invoke an AI model. A complete agent-generated report, with agent/model version, inputs, and run evidence, remains planned.

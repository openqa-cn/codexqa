...
What a finished HTML report looks like on this domain: [sample page](https://htmlpreview.github.io/?https://github.com/openqa-cn/codexqa/blob/main/docs/assets/previews/defect-report.html) (canned findings, same renderer).

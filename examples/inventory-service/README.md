...
What a finished HTML report looks like on this domain: [sample page](https://cdn.jsdelivr.net/gh/openqa-cn/codexqa@main/docs/assets/previews/defect-report.html) (canned findings, same renderer).

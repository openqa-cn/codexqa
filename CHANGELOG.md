...
- **Repository renamed from `openqa-skills` to `codexqa`.** The install path is now `npx skills add openqa-cn/codexqa`; badges, links, citation metadata, and documentation titles use the new name. The old GitHub URL redirects.
